...
```bash
# For google login:
http_proxy=http://127.0.0.1:7890 https_proxy=http://127.0.0.1:7890 all_proxy=socks5://127.0.0.1:7890 GOOGLE_CLOUD_PROJECT=test-project-key gemini -m gemini-2.5-pro
